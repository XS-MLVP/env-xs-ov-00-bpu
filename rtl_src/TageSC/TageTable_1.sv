...
module TageTable_1(	// src/main/scala/xiangshan/frontend/Tage.scala:240:7
  input         clock,
  input         reset,
  ...
  input  [6:0]  io_req_bits_folded_hist_hist_15_folded_hist,	// src/main/scala/xiangshan/frontend/Tage.scala:245:14
  input  [7:0]  io_req_bits_folded_hist_hist_4_folded_hist,	// src/main/scala/xiangshan/frontend/Tage.scala:245:14
  input  [10:0] io_req_bits_folded_hist_hist_1_folded_hist,	// src/main/scala/xiangshan/frontend/Tage.scala:245:14
  ...
  input  [6:0]  io_update_folded_hist_hist_15_folded_hist,	// src/main/scala/xiangshan/frontend/Tage.scala:245:14
  input  [7:0]  io_update_folded_hist_hist_4_folded_hist,	// src/main/scala/xiangshan/frontend/Tage.scala:245:14
  input  [10:0] io_update_folded_hist_hist_1_folded_hist,	// src/main/scala/xiangshan/frontend/Tage.scala:245:14
  ...
  wire [10:0] s0_idx = io_req_bits_pc[11:1] ^ io_req_bits_folded_hist_hist_1_folded_hist;	// src/main/scala/xiangshan/frontend/Tage.scala:290:29, :305:43
  ...
  wire [10:0] update_idx = io_update_pc[11:1] ^ io_update_folded_hist_hist_1_folded_hist;	// src/main/scala/xiangshan/frontend/Tage.scala:290:29, :305:43
  wire [7:0]  per_bank_update_wdata_3_1_tag =
    io_update_pc[8:1] ^ io_update_folded_hist_hist_4_folded_hist
    ^ {io_update_folded_hist_hist_15_folded_hist, 1'h0};	// src/main/scala/xiangshan/frontend/Tage.scala:272:86, :291:{29,38,52}, :305:43
  ...
  always @(posedge clock) begin
    if (_s1_bank_req_1h_T) begin	// src/main/scala/chisel3/util/Decoupled.scala:53:35
      ...
      s1_tag <=
        ...
        ^ {io_req_bits_folded_hist_hist_15_folded_hist, 1'h0};	// src/main/scala/xiangshan/frontend/Tage.scala:272:86, :291:{29,38,52}, :305:43, :332:25
