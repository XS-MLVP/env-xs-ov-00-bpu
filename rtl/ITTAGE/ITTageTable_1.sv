...
module ITTageTable_1(	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7]
  ...
  input  [7:0]  io_req_bits_folded_hist_hist_14_folded_hist,	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14]
  ...
  input  [7:0]  io_update_folded_hist_hist_14_folded_hist,	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14]
  ...
  wire [7:0]  s0_idx = io_req_bits_pc[8:1] ^ io_req_bits_folded_hist_hist_14_folded_hist;	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :205:43]
  ...
  wire [7:0]  update_idx = io_update_pc[8:1] ^ io_update_folded_hist_hist_14_folded_hist;	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :205:43]
  wire [8:0]  update_tag =
    {io_update_pc[17], io_update_pc[16:9] ^ io_update_folded_hist_hist_14_folded_hist}
    ^ {io_update_folded_hist_hist_14_folded_hist, 1'h0};	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :182:{32,52,61,75}, :205:43]
  ...
  always @(posedge clock) begin	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7]
    if (io_req_valid) begin	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14]
      s1_tag <=
        ...
        ^ {io_req_bits_folded_hist_hist_14_folded_hist, 1'h0};	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :182:{32,52,61,75}, :205:43, :211:68]
  ...
  FoldedSRAMTemplate_21 table_banks_0 (	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:217:44]
    ...
    .io_r_req_bits_setIdx        (s0_idx[7:1]),	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:161:37, :181:{31,40}]
    ...
    .io_w_req_bits_setIdx        (update_idx[7:1]),	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:161:37, :181:{31,40}]
