...
module data_mem_0_8x3(	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
  input  [2:0] R0_addr,
  input        R0_en,
  input        R0_clk,
  output [2:0] R0_data,
  ...
  reg [2:0] Memory[0:7];	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
    ...
    initial begin	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          ...
          Memory[i[2:0]] = _RANDOM_MEM[2:0];	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
        end	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 3'bx;	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
endmodule
