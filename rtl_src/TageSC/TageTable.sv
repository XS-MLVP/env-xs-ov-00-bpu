...
module TageTable(	// src/main/scala/xiangshan/frontend/Tage.scala:240:7
  ...
  wire [7:0]  per_bank_update_wdata_3_1_tag =
    _GEN_0 ^ {io_update_folded_hist_hist_7_folded_hist, 1'h0};	// src/main/scala/xiangshan/frontend/Tage.scala:272:86, :290:29, :291:{38,52}
  ...
  wire [2:0]  _GEN_2 = io_update_pc[1] ? io_update_oldCtrs_1 : io_update_oldCtrs_0;	// src/main/scala/xiangshan/frontend/BPU.scala:94:27, src/main/scala/xiangshan/frontend/Tage.scala:53:42, :305:43
  wire        _GEN_3 = (|_GEN_2) | _GEN_1;	// src/main/scala/xiangshan/frontend/BPU.scala:94:27, :95:30, :97:10, src/main/scala/xiangshan/frontend/Tage.scala:449:14
  ...
  wire [2:0]  per_bank_update_wdata_0_0_ctr =
    _GEN_4
      ? (_GEN_1 ? 3'h4 : 3'h3)
      : wrbypass_data_valid
          ? ((&_wrbypass_io_WIRE_2) & _GEN_1
               ? 3'h7
               : _wrbypass_io_WIRE_2 == 3'h0 & ~_GEN_1
                   ? 3'h0
                   : _GEN_1
          ...
          : (&_GEN_2) & _GEN_1
              ? 3'h7
              : _GEN_3 ? (_GEN_1 ? 3'(_GEN_2 + 3'h1) : 3'(_GEN_2 - 3'h1)) : 3'h0;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :95:30, :96:{8,21}, :97:{10,26,29}, :98:{12,24,35}, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :446:46, :448:12, :449:14, :450:14
  assign per_bank_not_silent_update_0_0 =
    (wrbypass_data_valid
       ? ~((&_wrbypass_io_WIRE_2) & _GEN_1 | _wrbypass_io_WIRE_2 == 3'h0 & ~_GEN_1)
       : ~((&_GEN_2) & _GEN_1 | _GEN_2 == 3'h0 & ~_GEN_1)) | _GEN_4;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :97:29, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :430:{9,14,23,31,35}, :446:46, :448:12, :449:14, :456:12, :457:11, :458:{11,81}
  ...
  wire [2:0]  _GEN_6 = io_update_pc[1] ? io_update_oldCtrs_0 : io_update_oldCtrs_1;	// src/main/scala/xiangshan/frontend/BPU.scala:94:27, src/main/scala/xiangshan/frontend/Tage.scala:53:42, :305:43
  ...
  wire [2:0]  per_bank_update_wdata_0_1_ctr =
    _GEN_7
      ...
      : wrbypass_data_valid_1
          ? ((&_wrbypass_io_WIRE_11) & _GEN_5
               ? 3'h7
               : _wrbypass_io_WIRE_11 == 3'h0 & ~_GEN_5
                   ? 3'h0
                   : _GEN_5
          ...
          : (&_GEN_6) & _GEN_5
              ...
              : _GEN_6 == 3'h0 & ~_GEN_5
                  ? 3'h0
                  : _GEN_5 ? 3'(_GEN_6 + 3'h1) : 3'(_GEN_6 - 3'h1);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :95:30, :96:{8,21}, :97:{10,26,29}, :98:{12,24,35}, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :446:46, :448:12, :449:14, :450:14
  assign per_bank_not_silent_update_0_1 =
    (wrbypass_data_valid_1
       ? ~((&_wrbypass_io_WIRE_11) & _GEN_5 | _wrbypass_io_WIRE_11 == 3'h0 & ~_GEN_5)
       : ~((&_GEN_6) & _GEN_5 | _GEN_6 == 3'h0 & ~_GEN_5)) | _GEN_7;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :97:29, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :430:{9,14,23,31,35}, :446:46, :448:12, :449:14, :456:12, :457:11, :458:{11,81}
  ...
  wire [2:0]  per_bank_update_wdata_1_0_ctr =
    _GEN_4
      ...
      : wrbypass_data_valid_2
          ? ((&_wrbypass_io_WIRE_20) & _GEN_1
               ? 3'h7
               : _wrbypass_io_WIRE_20 == 3'h0 & ~_GEN_1
                   ? 3'h0
                   : _GEN_1
  ...
  assign per_bank_not_silent_update_1_0 =
    (wrbypass_data_valid_2
       ? ~((&_wrbypass_io_WIRE_20) & _GEN_1 | _wrbypass_io_WIRE_20 == 3'h0 & ~_GEN_1)
       : ~((&_GEN_2) & _GEN_1 | _GEN_2 == 3'h0 & ~_GEN_1)) | _GEN_4;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :97:29, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :430:{9,14,23,31,35}, :446:46, :448:12, :449:14, :456:12, :457:11, :458:{11,81}
  ...
  wire [2:0]  per_bank_update_wdata_1_1_ctr =
    _GEN_7
      ...
      : wrbypass_data_valid_3
          ? ((&_wrbypass_io_WIRE_29) & _GEN_5
               ? 3'h7
               : _wrbypass_io_WIRE_29 == 3'h0 & ~_GEN_5
                   ? 3'h0
                   : _GEN_5
  ...
  assign per_bank_not_silent_update_1_1 =
    (wrbypass_data_valid_3
       ? ~((&_wrbypass_io_WIRE_29) & _GEN_5 | _wrbypass_io_WIRE_29 == 3'h0 & ~_GEN_5)
       : ~((&_GEN_6) & _GEN_5 | _GEN_6 == 3'h0 & ~_GEN_5)) | _GEN_7;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :97:29, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :430:{9,14,23,31,35}, :446:46, :448:12, :449:14, :456:12, :457:11, :458:{11,81}
  ...
  wire [2:0]  per_bank_update_wdata_2_0_ctr =
    _GEN_4
      ...
      : wrbypass_data_valid_4
          ? ((&_wrbypass_io_WIRE_38) & _GEN_1
               ? 3'h7
               : _wrbypass_io_WIRE_38 == 3'h0 & ~_GEN_1
                   ? 3'h0
                   : _GEN_1
  ...
  assign per_bank_not_silent_update_2_0 =
    (wrbypass_data_valid_4
       ? ~((&_wrbypass_io_WIRE_38) & _GEN_1 | _wrbypass_io_WIRE_38 == 3'h0 & ~_GEN_1)
       : ~((&_GEN_2) & _GEN_1 | _GEN_2 == 3'h0 & ~_GEN_1)) | _GEN_4;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :97:29, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :430:{9,14,23,31,35}, :446:46, :448:12, :449:14, :456:12, :457:11, :458:{11,81}
  ...
  wire [2:0]  per_bank_update_wdata_2_1_ctr =
    _GEN_7
      ...
      : wrbypass_data_valid_5
          ? ((&_wrbypass_io_WIRE_47) & _GEN_5
               ? 3'h7
               : _wrbypass_io_WIRE_47 == 3'h0 & ~_GEN_5
                   ? 3'h0
                   : _GEN_5
  ...
  assign per_bank_not_silent_update_2_1 =
    (wrbypass_data_valid_5
       ? ~((&_wrbypass_io_WIRE_47) & _GEN_5 | _wrbypass_io_WIRE_47 == 3'h0 & ~_GEN_5)
       : ~((&_GEN_6) & _GEN_5 | _GEN_6 == 3'h0 & ~_GEN_5)) | _GEN_7;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :97:29, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :430:{9,14,23,31,35}, :446:46, :448:12, :449:14, :456:12, :457:11, :458:{11,81}
  ...
  wire [2:0]  per_bank_update_wdata_3_0_ctr =
    _GEN_4
      ...
      : wrbypass_data_valid_6
          ? ((&_wrbypass_io_WIRE_56) & _GEN_1
               ? 3'h7
               : _wrbypass_io_WIRE_56 == 3'h0 & ~_GEN_1
                   ? 3'h0
                   : _GEN_1
  ...
  assign per_bank_not_silent_update_3_0 =
    (wrbypass_data_valid_6
       ? ~((&_wrbypass_io_WIRE_56) & _GEN_1 | _wrbypass_io_WIRE_56 == 3'h0 & ~_GEN_1)
       : ~((&_GEN_2) & _GEN_1 | _GEN_2 == 3'h0 & ~_GEN_1)) | _GEN_4;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :97:29, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :430:{9,14,23,31,35}, :446:46, :448:12, :449:14, :456:12, :457:11, :458:{11,81}
  ...
  wire [2:0]  per_bank_update_wdata_3_1_ctr =
    _GEN_7
      ...
      : wrbypass_data_valid_7
          ? ((&_wrbypass_io_WIRE_65) & _GEN_5
               ? 3'h7
               : _wrbypass_io_WIRE_65 == 3'h0 & ~_GEN_5
                   ? 3'h0
                   : _GEN_5
  ...
  assign per_bank_not_silent_update_3_1 =
    (wrbypass_data_valid_7
       ? ~((&_wrbypass_io_WIRE_65) & _GEN_5 | _wrbypass_io_WIRE_65 == 3'h0 & ~_GEN_5)
       : ~((&_GEN_6) & _GEN_5 | _GEN_6 == 3'h0 & ~_GEN_5)) | _GEN_7;	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:94:27, :97:29, src/main/scala/xiangshan/frontend/Tage.scala:240:7, :430:{9,14,23,31,35}, :446:46, :448:12, :449:14, :456:12, :457:11, :458:{11,81}
  ...
  FoldedSRAMTemplate_1 table_banks_3 (	// src/main/scala/xiangshan/frontend/Tage.scala:315:11
    ...
    .io_r_req_valid           (_s1_bank_req_1h_T & (&(_GEN[1:0]))),	// src/main/scala/chisel3/util/Decoupled.scala:53:35, src/main/scala/xiangshan/frontend/Tage.scala:272:{66,86}, :290:{29,38}, :322:52
    .io_r_req_bits_setIdx     (_table_banks_3_io_r_req_bits_setIdx_T),	// src/main/scala/xiangshan/frontend/Tage.scala:273:37, :290:38
