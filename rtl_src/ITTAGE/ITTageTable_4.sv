...
module ITTageTable_4(	// src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7
  input         clock,
  input         reset,
  ...
  input  [8:0]  io_req_bits_folded_hist_hist_10_folded_hist,	// src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14
  input  [7:0]  io_req_bits_folded_hist_hist_3_folded_hist,	// src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14
  ...
  input  [8:0]  io_update_folded_hist_hist_10_folded_hist,	// src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14
  input  [7:0]  io_update_folded_hist_hist_3_folded_hist,	// src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14
  ...
  wire [8:0]   s0_idx = io_req_bits_pc[9:1] ^ io_req_bits_folded_hist_hist_10_folded_hist;	// src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :207:43
  ...
  wire [8:0]   update_idx = io_update_pc[9:1] ^ io_update_folded_hist_hist_10_folded_hist;	// src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :207:43
  wire [8:0]   update_wdata_tag =
    io_update_pc[18:10] ^ io_update_folded_hist_hist_10_folded_hist
    ^ {io_update_folded_hist_hist_3_folded_hist, 1'h0};	// src/main/scala/xiangshan/frontend/ITTAGE.scala:160:86, :182:{32,52,61,75}, :207:43
  ...
  always @(posedge clock) begin
    if (io_req_valid) begin	// src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14
      ...
      s1_tag <=
        ...
        ^ {io_req_bits_folded_hist_hist_3_folded_hist, 1'h0};	// src/main/scala/xiangshan/frontend/ITTAGE.scala:160:86, :182:{32,52,61,75}, :207:43, :213:68
