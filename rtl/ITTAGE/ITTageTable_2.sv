...
module ITTageTable_2(	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7]
  ...
  wire [8:0]  s0_idx = io_req_bits_pc[9:1] ^ io_req_bits_folded_hist_hist_13_folded_hist;	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :205:43]
  ...
  wire [8:0]  update_idx = io_update_pc[9:1] ^ io_update_folded_hist_hist_13_folded_hist;	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :205:43]
  wire [8:0]  update_tag =
    io_update_pc[18:10] ^ io_update_folded_hist_hist_13_folded_hist
    ^ {io_update_folded_hist_hist_4_folded_hist, 1'h0};	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :182:{32,52,61,75}, :205:43]
  ...
  always @(posedge clock) begin	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7]
    if (io_req_valid) begin	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14]
      s1_tag <=
        ...
        ^ {io_req_bits_folded_hist_hist_4_folded_hist, 1'h0};	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :182:{32,52,61,75}, :205:43, :211:68]
