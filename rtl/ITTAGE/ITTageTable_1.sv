...
module ITTageTable_1(	// src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7
  ...
  wire [7:0]   s0_idx = io_req_bits_pc[8:1] ^ io_req_bits_folded_hist_hist_14_folded_hist;	// src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :207:43
  ...
  wire [7:0]   update_idx = io_update_pc[8:1] ^ io_update_folded_hist_hist_14_folded_hist;	// src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :207:43
  wire [8:0]   update_wdata_tag =
    {io_update_pc[17], io_update_pc[16:9] ^ io_update_folded_hist_hist_14_folded_hist}
    ^ {io_update_folded_hist_hist_14_folded_hist, 1'h0};	// src/main/scala/xiangshan/frontend/ITTAGE.scala:160:86, :182:{32,52,61,75}, :207:43
  ...
  wire [255:0] _validArray_T =
    {io_update_valid & (&update_idx) | validArray[255],
     ...
     io_update_valid & update_idx == 8'h0 | validArray[0]};	// src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :200:27, :283:{30,42}, :284:26, :285:31, :286:33
  ...
  always @(posedge clock) begin
    if (io_req_valid) begin	// src/main/scala/xiangshan/frontend/ITTAGE.scala:145:14
      ...
      s1_tag <=
        ...
        ^ {io_req_bits_folded_hist_hist_14_folded_hist, 1'h0};	// src/main/scala/xiangshan/frontend/ITTAGE.scala:160:86, :182:{32,52,61,75}, :207:43, :213:68
