...
module DelayN_6(	// utility/src/main/scala/utility/Hold.scala:83:7
  input  clock,
  input  io_in,	// utility/src/main/scala/utility/Hold.scala:84:14
  output io_out	// utility/src/main/scala/utility/Hold.scala:84:14
);

  reg REG;	// utility/src/main/scala/utility/Hold.scala:90:18
  reg REG_1;	// utility/src/main/scala/utility/Hold.scala:90:18
  ...
  `ifdef ENABLE_INITIAL_REG_	// utility/src/main/scala/utility/Hold.scala:83:7
    ...
    logic [31:0] _RANDOM[0:0];	// utility/src/main/scala/utility/Hold.scala:83:7
    initial begin	// utility/src/main/scala/utility/Hold.scala:83:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// utility/src/main/scala/utility/Hold.scala:83:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// utility/src/main/scala/utility/Hold.scala:83:7
        REG = _RANDOM[/*Zero width*/ 1'b0][0];	// utility/src/main/scala/utility/Hold.scala:83:7, :90:18
        REG_1 = _RANDOM[/*Zero width*/ 1'b0][1];	// utility/src/main/scala/utility/Hold.scala:83:7, :90:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
