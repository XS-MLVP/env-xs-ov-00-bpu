...
module SCTable_2(	// src/main/scala/xiangshan/frontend/SC.scala:66:7
  input         clock,
  input         reset,
  ...
  input  [7:0]  io_req_bits_folded_hist_hist_11_folded_hist,	// src/main/scala/xiangshan/frontend/SC.scala:68:14
  ...
  input  [7:0]  io_update_folded_hist_hist_11_folded_hist,	// src/main/scala/xiangshan/frontend/SC.scala:68:14
  ...
  wire [7:0]  update_idx = io_update_pc[8:1] ^ io_update_folded_hist_hist_11_folded_hist;	// src/main/scala/xiangshan/frontend/SC.scala:86:31, :117:42
  wire        ctrPos =
  ...
  SRAMTemplate_31 table_0 (	// src/main/scala/xiangshan/frontend/SC.scala:71:21
    ...
    .io_r_req_bits_setIdx
      (io_req_bits_pc[8:1] ^ io_req_bits_folded_hist_hist_11_folded_hist),	// src/main/scala/xiangshan/frontend/SC.scala:86:{12,31}
