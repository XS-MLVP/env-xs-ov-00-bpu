...
module data_mem_8x4(	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
  input  [2:0] R0_addr,
  input        R0_en,
  input        R0_clk,
  output [3:0] R0_data,
  ...
  reg [3:0] Memory[0:7];	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
  always @(posedge W0_clk) begin	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
    if (W0_en & W0_mask[0])	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
      Memory[W0_addr][32'h0 +: 2] <= W0_data[1:0];	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
    if (W0_en & W0_mask[1])	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
      Memory[W0_addr][32'h2 +: 2] <= W0_data[3:2];	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
  end // always @(posedge)
    ...
    initial begin	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          ...
          Memory[i[2:0]] = _RANDOM_MEM[3:0];	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
        end	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 4'bx;	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
  assign R1_data = R1_en ? Memory[R1_addr] : 4'bx;	// @[src/main/scala/xiangshan/frontend/WrBypass.scala:54:21]
endmodule
