...
module TageBTable(	// @[src/main/scala/xiangshan/frontend/Tage.scala:137:7]
  input         clock,	// @[src/main/scala/xiangshan/frontend/Tage.scala:137:7]
  input         reset,	// @[src/main/scala/xiangshan/frontend/Tage.scala:137:7]
  ...
  input  [40:0] io_req_bits,	// @[src/main/scala/xiangshan/frontend/Tage.scala:138:14]
  ...
  input  [40:0] io_update_pc,	// @[src/main/scala/xiangshan/frontend/Tage.scala:138:14]
  ...
  always @(posedge clock or posedge reset) begin	// @[src/main/scala/xiangshan/frontend/Tage.scala:137:7]
    ...
    else begin	// @[src/main/scala/xiangshan/frontend/Tage.scala:137:7]
  ...
  always @(posedge clock) begin	// @[src/main/scala/xiangshan/frontend/Tage.scala:137:7]
    if (io_req_valid)	// @[src/main/scala/xiangshan/frontend/Tage.scala:138:14]
      s1_idx <= io_req_bits[11:1];	// @[src/main/scala/xiangshan/frontend/FrontendBundle.scala:400:65, src/main/scala/xiangshan/frontend/Tage.scala:181:25]
  end // always @(posedge)
  ...
  FoldedSRAMTemplate_20 bt (	// @[src/main/scala/xiangshan/frontend/Tage.scala:154:18]
    ...
    .io_r_req_bits_setIdx  (io_req_bits[11:1]),	// @[src/main/scala/xiangshan/frontend/FrontendBundle.scala:400:65]
    ...
    .io_w_req_bits_setIdx  (doing_reset ? resetRow : io_update_pc[11:1]),	// @[src/main/scala/xiangshan/frontend/FrontendBundle.scala:400:65, src/main/scala/xiangshan/frontend/Tage.scala:166:28, :167:25, :233:17]
  ...
  WrBypass_32 wrbypass (	// @[src/main/scala/xiangshan/frontend/Tage.scala:192:24]
    ...
    .io_write_idx        (io_update_pc[11:1]),	// @[src/main/scala/xiangshan/frontend/FrontendBundle.scala:400:65]
