...
module SCTable_1(	// src/main/scala/xiangshan/frontend/SC.scala:66:7
  input         clock,
  input         reset,
  input         io_req_valid,	// src/main/scala/xiangshan/frontend/SC.scala:68:14
  input  [38:0] io_req_bits_pc,	// src/main/scala/xiangshan/frontend/SC.scala:68:14
  input  [3:0]  io_req_bits_folded_hist_hist_12_folded_hist,	// src/main/scala/xiangshan/frontend/SC.scala:68:14
  ...
  input  [38:0] io_update_pc,	// src/main/scala/xiangshan/frontend/SC.scala:68:14
  input  [3:0]  io_update_folded_hist_hist_12_folded_hist,	// src/main/scala/xiangshan/frontend/SC.scala:68:14
  ...
  reg  [38:0] s1_pc;	// src/main/scala/xiangshan/frontend/SC.scala:99:24
  wire        per_br_update_way_mask_0_0 =
  ...
  wire        per_br_update_way_mask_0_1 =
    io_update_mask_0 & ~(io_update_pc[1]) & io_update_tagePreds_0 | io_update_mask_1
  ...
  wire        per_br_update_way_mask_1_0 =
    io_update_mask_0 & io_update_pc[1] & ~io_update_tagePreds_0 | io_update_mask_1
  ...
  wire        per_br_update_way_mask_1_1 =
    io_update_mask_0 & io_update_pc[1] & io_update_tagePreds_0 | io_update_mask_1
  ...
  wire [7:0]  update_idx =
    {io_update_pc[8:5], io_update_pc[4:1] ^ io_update_folded_hist_hist_12_folded_hist};	// src/main/scala/xiangshan/frontend/SC.scala:86:{31,40}, :117:42
  wire        ctrPos =
  ...
  wire [5:0]  per_br_update_wdata_packed_0_1 =
    oldCtr == 6'h1F & taken
      ? 6'h1F
      : oldCtr == 6'h20 & ~taken ? 6'h20 : taken ? 6'(oldCtr + 6'h1) : 6'(oldCtr - 6'h1);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:102:27, :103:30, :104:{8,21}, :105:{10,26,29}, :106:{12,24,35}, src/main/scala/xiangshan/frontend/SC.scala:150:21
  wire        ctrPos_1 =
  ...
  wire [5:0]  per_br_update_wdata_packed_1_1 =
    oldCtr_1 == 6'h1F & taken_1
      ? 6'h1F
      : oldCtr_1 == 6'h20 & ~taken_1
          ? 6'h20
          : taken_1 ? 6'(oldCtr_1 + 6'h1) : 6'(oldCtr_1 - 6'h1);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:102:27, :103:30, :104:{8,21}, :105:{10,26,29}, :106:{12,24,35}, src/main/scala/xiangshan/frontend/SC.scala:150:21
  wire [5:0]  _GEN =
    (io_update_pc[1] ? 6'h0 : per_br_update_wdata_packed_0_1)
    | (io_update_pc[1] ? per_br_update_wdata_packed_1_1 : 6'h0);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:104:8, src/main/scala/xiangshan/frontend/SC.scala:117:42, src/main/scala/xiangshan/frontend/Tage.scala:53:42
  wire [5:0]  _GEN_0 =
    (io_update_pc[1] ? per_br_update_wdata_packed_0_1 : 6'h0)
    | (io_update_pc[1] ? 6'h0 : per_br_update_wdata_packed_1_1);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/BPU.scala:104:8, src/main/scala/xiangshan/frontend/SC.scala:117:42, src/main/scala/xiangshan/frontend/Tage.scala:53:42
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/xiangshan/frontend/SC.scala:66:7
    ...
    initial begin	// src/main/scala/xiangshan/frontend/SC.scala:66:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/xiangshan/frontend/SC.scala:66:7
        ...
        s1_pc = {_RANDOM[1'h0][31:8], _RANDOM[1'h1][14:0]};	// src/main/scala/xiangshan/frontend/SC.scala:66:7, :99:24
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  SRAMTemplate_31 table_0 (	// src/main/scala/xiangshan/frontend/SC.scala:71:21
    .clock                 (clock),
    .reset                 (reset),
    .io_r_req_valid        (io_req_valid),
    .io_r_req_bits_setIdx
      ({io_req_bits_pc[8:5],
        io_req_bits_pc[4:1] ^ io_req_bits_folded_hist_hist_12_folded_hist}),	// src/main/scala/xiangshan/frontend/SC.scala:86:{12,31,40}
    ...
    .io_w_req_bits_setIdx  (update_idx),	// src/main/scala/xiangshan/frontend/SC.scala:86:40
    .io_w_req_bits_data_0  (per_br_update_wdata_packed_0_1),	// src/main/scala/xiangshan/frontend/BPU.scala:104:8
    .io_w_req_bits_data_1  (per_br_update_wdata_packed_0_1),	// src/main/scala/xiangshan/frontend/BPU.scala:104:8
    .io_w_req_bits_data_2  (per_br_update_wdata_packed_1_1),	// src/main/scala/xiangshan/frontend/BPU.scala:104:8
    .io_w_req_bits_data_3  (per_br_update_wdata_packed_1_1),	// src/main/scala/xiangshan/frontend/BPU.scala:104:8
    .io_w_req_bits_waymask
      ({per_br_update_way_mask_1_1,
        per_br_update_way_mask_1_0,
        per_br_update_way_mask_0_1,
        per_br_update_way_mask_0_0})	// src/main/scala/xiangshan/frontend/SC.scala:121:15, :124:15, :133:29
  );
  WrBypass_33 wrbypasses_0 (	// src/main/scala/xiangshan/frontend/SC.scala:139:42
    .clock               (clock),
    .reset               (reset),
    .io_wen              (io_update_mask_0),
    .io_write_idx        (update_idx),	// src/main/scala/xiangshan/frontend/SC.scala:86:40
    .io_write_data_0     (_GEN),	// src/main/scala/chisel3/util/Mux.scala:30:73
    .io_write_data_1     (_GEN),	// src/main/scala/chisel3/util/Mux.scala:30:73
    .io_write_way_mask_0
      (~(io_update_pc[1]) & per_br_update_way_mask_0_0 | io_update_pc[1]
       & per_br_update_way_mask_1_0),	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, src/main/scala/xiangshan/frontend/SC.scala:117:42, :121:15, src/main/scala/xiangshan/frontend/Tage.scala:53:42
    .io_write_way_mask_1
      (~(io_update_pc[1]) & per_br_update_way_mask_0_1 | io_update_pc[1]
       & per_br_update_way_mask_1_1),	// src/main/scala/chisel3/util/Mux.scala:30:73, :32:36, src/main/scala/xiangshan/frontend/SC.scala:117:42, :124:15, src/main/scala/xiangshan/frontend/Tage.scala:53:42
  ...
  WrBypass_33 wrbypasses_1 (	// src/main/scala/xiangshan/frontend/SC.scala:139:42
    ...
    .io_write_idx        (update_idx),	// src/main/scala/xiangshan/frontend/SC.scala:86:40
    .io_write_data_0     (_GEN_0),	// src/main/scala/chisel3/util/Mux.scala:30:73
    .io_write_data_1     (_GEN_0),	// src/main/scala/chisel3/util/Mux.scala:30:73
    .io_write_way_mask_0
      (io_update_pc[1] & per_br_update_way_mask_0_0 | ~(io_update_pc[1])
       & per_br_update_way_mask_1_0),	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/SC.scala:117:42, :121:15, src/main/scala/xiangshan/frontend/Tage.scala:53:42, :55:92
    .io_write_way_mask_1
      (io_update_pc[1] & per_br_update_way_mask_0_1 | ~(io_update_pc[1])
       & per_br_update_way_mask_1_1),	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/xiangshan/frontend/SC.scala:117:42, :124:15, src/main/scala/xiangshan/frontend/Tage.scala:53:42, :55:92
