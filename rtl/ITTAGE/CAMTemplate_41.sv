...
module CAMTemplate_41(	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7]
  ...
  always @(posedge clock) begin	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7]
    if (io_w_valid & io_w_bits_index == 2'h0)	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:164:18, :170:21, :171:28]
      array_0 <= io_w_bits_data_idx;	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:164:18]
    if (io_w_valid & io_w_bits_index == 2'h1)	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:164:18, :170:21, :171:28]
      array_1 <= io_w_bits_data_idx;	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:164:18]
    if (io_w_valid & io_w_bits_index == 2'h2)	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:164:18, :170:21, :171:28]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7]
    ...
    logic [31:0] _RANDOM[0:0];	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7]
    initial begin	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7]
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7]
        array_0 = _RANDOM[/*Zero width*/ 1'b0][7:0];	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7, :164:18]
        array_1 = _RANDOM[/*Zero width*/ 1'b0][15:8];	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7, :164:18]
        array_2 = _RANDOM[/*Zero width*/ 1'b0][23:16];	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7, :164:18]
        array_3 = _RANDOM[/*Zero width*/ 1'b0][31:24];	// @[src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:148:7, :164:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
