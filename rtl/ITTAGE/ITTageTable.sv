...
module ITTageTable(	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7]
  ...
  wire [3:0]  _GEN = io_req_bits_pc[4:1] ^ io_req_bits_folded_hist_hist_12_folded_hist;	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :205:43]
  ...
  wire [3:0]  _GEN_0 = io_update_pc[4:1] ^ io_update_folded_hist_hist_12_folded_hist;	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:181:31, :205:43]
  ...
  wire [8:0]  update_tag =
    {io_update_pc[17:14],
     {io_update_pc[13], io_update_pc[12:9] ^ io_update_folded_hist_hist_12_folded_hist}
       ^ {io_update_folded_hist_hist_12_folded_hist, 1'h0}};	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :182:{32,52,61,75,82}, :205:43]
  ...
  wire        _s1_bank_has_write_on_this_req_WIRE_0 = io_update_valid & ~(_GEN_0[0]);	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:160:{66,86}, :181:{31,40}, :254:33]
  wire        _s1_bank_has_write_on_this_req_WIRE_1 = io_update_valid & _GEN_0[0];	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:160:66, :181:{31,40}, :254:33]
  wire [1:0]  old_ctr =
        ...
        {io_req_bits_pc[17:14],
         {io_req_bits_pc[13],
          io_req_bits_pc[12:9] ^ io_req_bits_folded_hist_hist_12_folded_hist}
           ^ {io_req_bits_folded_hist_hist_12_folded_hist, 1'h0}};	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :182:{32,52,61,75,82}, :205:43, :211:68]
      s1_bank_req_1h_0 <= ~(_GEN[0]);	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:160:{66,86}, :181:{31,40}, :213:33]
      s1_bank_req_1h_1 <= _GEN[0];	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:160:66, :181:{31,40}, :213:33]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7]
    ...
    initial begin	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7]
        ...
        s1_tag = _RANDOM[/*Zero width*/ 1'b0][16:8];	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :211:68]
        s1_bank_req_1h_0 = _RANDOM[/*Zero width*/ 1'b0][17];	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :211:68, :213:33]
        s1_bank_req_1h_1 = _RANDOM[/*Zero width*/ 1'b0][18];	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :211:68, :213:33]
        s1_bank_has_write_on_this_req_0 = _RANDOM[/*Zero width*/ 1'b0][19];	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :211:68, :239:48]
        s1_bank_has_write_on_this_req_1 = _RANDOM[/*Zero width*/ 1'b0][20];	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:140:7, :211:68, :239:48]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Folded1WDataModuleTemplate us (	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:215:18]
    .clock      (clock),
    .reset      (reset),
    .io_ren_0   (io_req_valid),
    .io_raddr_0 ({io_req_bits_pc[8:5], _GEN}),	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:181:{31,40}]
  ...
  FoldedSRAMTemplate_21 table_banks_0 (	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:217:44]
    .clock                       (clock),
    .reset                       (reset),
    .io_r_req_valid              (io_req_valid & ~(_GEN[0])),	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:160:{66,86}, :181:{31,40}, :221:50]
    ...
    .io_w_req_bits_data_0_tag    (update_tag),	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:182:82]
  ...
  FoldedSRAMTemplate_21 table_banks_1 (	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:217:44]
    .clock                       (clock),
    .reset                       (reset),
    .io_r_req_valid              (io_req_valid & _GEN[0]),	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:160:66, :181:{31,40}, :221:50]
    .io_r_req_bits_setIdx        (_table_banks_1_io_r_req_bits_setIdx_T),	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:161:37, :181:40]
  ...
  WrBypass_41 wrbypass (	// @[src/main/scala/xiangshan/frontend/ITTAGE.scala:270:24]
    .clock              (clock),
    .reset              (reset),
