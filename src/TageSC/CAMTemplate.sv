...
module CAMTemplate(	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7
  input        clock,
  ...
  reg [8:0] array_4;	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:152:18
  reg [8:0] array_5;	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:152:18
  reg [8:0] array_6;	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:152:18
  reg [8:0] array_7;	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:152:18
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7
    ...
    initial begin	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7
        ...
        array_0 = _RANDOM[2'h0][8:0];	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7, :152:18
        array_1 = _RANDOM[2'h0][17:9];	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7, :152:18
        array_2 = _RANDOM[2'h0][26:18];	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7, :152:18
        array_3 = {_RANDOM[2'h0][31:27], _RANDOM[2'h1][3:0]};	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7, :152:18
        array_4 = _RANDOM[2'h1][12:4];	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7, :152:18
        array_5 = _RANDOM[2'h1][21:13];	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7, :152:18
        array_6 = _RANDOM[2'h1][30:22];	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7, :152:18
        array_7 = {_RANDOM[2'h1][31], _RANDOM[2'h2][7:0]};	// src/main/scala/xiangshan/cache/mmu/MMUBundle.scala:136:7, :152:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
