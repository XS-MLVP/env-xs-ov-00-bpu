...
module FoldedSRAMTemplate_1(	// @[utility/src/main/scala/utility/SRAMTemplate.scala:227:7]
  ...
  input  [8:0] io_r_req_bits_setIdx,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  output       io_r_resp_data_0_valid,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  output [7:0] io_r_resp_data_0_tag,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  output [2:0] io_r_resp_data_0_ctr,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  output       io_r_resp_data_1_valid,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  output [7:0] io_r_resp_data_1_tag,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  output [2:0] io_r_resp_data_1_ctr,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  input        io_w_req_valid,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  input  [8:0] io_w_req_bits_setIdx,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  input  [7:0] io_w_req_bits_data_0_tag,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  input  [2:0] io_w_req_bits_data_0_ctr,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  input  [7:0] io_w_req_bits_data_1_tag,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  input  [2:0] io_w_req_bits_data_1_ctr,	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
  input  [1:0] io_w_req_bits_waymask	// @[utility/src/main/scala/utility/SRAMTemplate.scala:233:14]
);

  SRAMTemplate_15 array (	// @[utility/src/main/scala/utility/SRAMTemplate.scala:247:21]
    .clock                    (clock),
    .reset                    (reset),
